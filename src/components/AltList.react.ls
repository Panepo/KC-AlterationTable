						...
						for data, i in @props.output
							tr key:i, id:@props.tableId + i.toString() + "tr",
								td className: Constants.TbodyClass[0],
									label className: "table-checkbox mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect mdl-data-table__select", htmlFor: @props.tableId + i.toString(),
								...
								td className: Constants.TbodyClass[1],
									img className: "table-image", src: data.img, height: "25", width: "25", null
								...
								td className: Constants.TbodyClass[5],
									if data.owner.length !== 0
										img className: "table-image", src: "./img/" + data.owner + ".jpg", height: "25", width: "100", null
